...
const load = Vue.createApp({
  setup () {
    ...
    //   CarouselSubText4: 'Photo captured by: Robinerino#1312',
      ...
      DownloadTitle: 'Téléchargement des ressources',
      DownloadDesc: "Patientez pendant que nous téléchargeons les ressources requises. \n\nLe chargement peut-être long, ne quittez pas votre PC, vous serez amené en jeu directement après ! ",
