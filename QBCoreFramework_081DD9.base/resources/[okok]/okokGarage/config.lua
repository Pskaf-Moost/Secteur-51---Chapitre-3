...
Config.FuelResource = "legacyfuel" -- "nothing" - no fuel resource, "native" - will use the FiveM natives, "okokGasStation", "legacyfuel", "ox_fuel"

Config.CameraEnabled = true -- Camera animation when taking out a vehicle

Config.ImageType = "type" -- "default" - each vehicle uses a unique image (e.g. Zentorno - zentorno.png), "type" - each vehicle type uses an image (e.g. Zentorno - car.png), "single" - all vehicles use the same image (e.g. Zentorno - vehicle.png)
...
Config.UseOkokVehicleKeys = false
Config.KeySystem = "qb-vehiclekeys" -- if Config.UseOkokVehicleKeys = false, you can change this to another key system ( okokVehicleKeys, qs-vehiclekeys, wasabi-keys, qb-vehiclekeys, jaksam-keys, custom )
...
Config.KeyMetaData = { -- Items will be used instead of the "U" key to lock/unlock vehicles. (Only ox-inventory supported at the moment - if you use another inventory with metadata and would like support to it to be added, please let us know through the tickets)
	inventoryResourceName = "qb_inventory",
	keyItemName = "keys",
	oxInventory = false,
	qbInventory = false,
	qsInventory = false,
...
Config.Impound = { -- Garages list/info
	{
		...
		blip = { blipId = 524, blipColor = 5, blipScale = 0.9, blipText = "Fourriere" }, -- Blip informations
		marker = { id = 36, color = { r = 31, g = 94, b = 255, a = 90 }, size = { x = 0.7, y = 0.7, z = 0.7 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0, textureDict = 0, textureName = 0 }, -- Marker informations
		radius = 1, -- Interaction radius for the marker
...
Config.RecoverVehicle = {
	{
		...
		blip = { blipId = 524, blipColor = 3, blipScale = 0, blipText = "Recover Vehicle" }, -- Blip informations
		marker = { id = 36, color = { r = 31, g = 94, b = 255, a = 90 }, size = { x = 0.7, y = 0.7, z = 0.7 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0, textureDict = 0, textureName = 0 }, -- Marker informations
		radius = 1, -- Interaction radius for the marker
		vehicleSpawn = { -- Where the vehicle spawns when you recover it
