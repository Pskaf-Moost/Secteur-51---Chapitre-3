...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(460.96, -996.67, 30.69, 89.99),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
...
Config.Outfits = {
    ["police"] = {
        ["Male"] = {
            {
                name = "Tenue LSPD",
                outfitData = {
                    ["pants"] = {item = 204, texture = 0}, -- Pants
                    ["arms"] = {item = 248, texture = 0}, -- Arms
                    ["t-shirt"] = {item = 15, texture = 0}, -- T Shirt
                    ["vest"] = {item = 79, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 534, texture = 1}, -- Jacket
                    ["shoes"] = {item = 150, texture = 0}, -- Shoes
        ...
        ["Female"] = {
            {
                name = "Equipements LSPD",
                outfitData = {
                    ["pants"] = {item = 212, texture = 0}, -- Pants
                    ["arms"] = {item = 33, texture = 0}, -- Arms
                    ["t-shirt"] = {item = 2, texture = 0}, -- T Shirt
                    ["vest"] = {item = 72, texture = 0}, -- Gilet pare balle
                    ["torso2"] = {item = 614, texture = 0}, -- Vestes
                    ["shoes"] = {item = 231, texture = 0}, -- Shoes
                    ["accessory"] = {item = 0, texture = 0}, -- Neck Accessory
                    ["bag"] = {item = 0, texture = 0}, -- Bag
