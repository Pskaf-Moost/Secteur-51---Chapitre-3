...
Config.PhoneNumber = {}
Config.PhoneNumber.Format = "({2}) {3}-{3}" -- Don't touch unless you know what you're doing. IMPORTANT: The sum of the numbers needs to be equal to the phone number length + prefix length
...
Config.UploadMethod.Video = "Discord" -- "Fivemanage" or "LBUpload" or "Custom"
Config.UploadMethod.Image = "Discord" -- "Fivemanage" or "LBUpload" or "Custom
Config.UploadMethod.Audio = "Discord" -- "Fivemanage" or "LBUpload" or "Custom"
